...
- Do not consider or check any possible API/network failures during save
- Do not consider behavior of any other fields beside the field 'Name'

## Program Name specifications

- leading/trailing whitespaces leaft in the input field should be trimmed in the saved name
- the only allowed special characters are: %, &, @, -, ., , (comma), "
- the Program names should be considered as duplacated, if they only have different whitespaces number or different case letters
