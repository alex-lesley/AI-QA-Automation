...
- Do not consider any search options on the Programs page
- Do not consider any edge cases treating the special charactes or whitespaces in the program names and descriptions, the program names duplications, or the maximal program name and description length
- Consider edge cases treating the length of the programs list
